...
var barSpec = {
  ...
  height: 450,
  title: {
    text: "Mean Income vs Mean Expenditure by State",
    fontSize: 16,
    anchor: "middle",
  },
  params: [
  ...
  transform: [
    ...
    {
      calculate:
        "(datum.income - datum.expenditure) / datum.income * 100",
      as: "savings_rate",
    },
  ],
  encoding: {
  ...
  layer: [
    {
      ...
      encoding: {
        x: {
          field: "state",
          type: "nominal",
          sort: { field: "income", order: "descending" },
        },
        y: {
          field: "income",
          type: "quantitative",
        ...
        tooltip: [
          ...
          { value: "Mean Income", title: "Category" },
          {
            field: "income",
            type: "quantitative",
            title: "Amount (RM)",
    ...
    },
    {
      ...
      encoding: {
        ...
        tooltip: [
          { field: "state", type: "nominal", title: "State" },
          { value: "Mean Expenditure", title: "Category" },
          {
            field: "expenditure",
            type: "quantitative",
            title: "Amount (RM)",
